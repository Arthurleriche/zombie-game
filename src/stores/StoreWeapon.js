...
export const machineGunHero = writable(false)
...
export const gunBullet = writable(1)
export const machineGunBullet = writable(1)

export const chooseWeapon = writable("sabre")
export const weapons = writable(["sabre"])
