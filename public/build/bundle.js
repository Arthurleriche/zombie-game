...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 109, 0, 2625);
    			attr_dev(div0, "id", "tableau");
    			add_location(div0, file$2, 111, 2, 2728);
    			attr_dev(div1, "class", "tableau ");
    			add_location(div1, file$2, 110, 0, 2703);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function createAlien(lig, col) {
    		this.lig = lig;
    		this.col = col;
    		set_store_value(tableau, $tableau[lig][col] = "z", $tableau);
    	...
    	$$self.$inject_state = $$props => {
    		if ("interval4" in $$props) interval4 = $$props.interval4;
    	};
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 18, 2, 328);
    			attr_dev(div, "class", "alien1 svelte-17qgt3r");
    			add_location(div, file$6, 17, 0, 305);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onDestroy, onMount, tableau, alienStep });
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$tableau*/ 4) case_1_changes.idCase = /*col*/ ctx[35];
    ...
    // (274:6) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
    	let each_value_1 = /*lig*/ ctx[32];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$8, 274, 8, 6986);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(274:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 271, 2, 6910);
    			attr_dev(div1, "class", "flex flex-col justify-around h-auto w-full");
    			add_location(div1, file$8, 270, 0, 6851);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*gameOver, $tableau, stp*/ 7 | dirty[1] & /*$$scope*/ 128) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	let $retry;
    	validate_store(ligAlien, "ligAlien");
    	component_subscribe($$self, ligAlien, $$value => $$invalidate(9, $ligAlien = $$value));
    	validate_store(colAlien, "colAlien");
    	component_subscribe($$self, colAlien, $$value => $$invalidate(10, $colAlien = $$value));
    	validate_store(bottomSide, "bottomSide");
    	component_subscribe($$self, bottomSide, $$value => $$invalidate(11, $bottomSide = $$value));
    	validate_store(leftSide, "leftSide");
    	component_subscribe($$self, leftSide, $$value => $$invalidate(12, $leftSide = $$value));
    	validate_store(tableau, "tableau");
    	component_subscribe($$self, tableau, $$value => $$invalidate(2, $tableau = $$value));
    	validate_store(colHero, "colHero");
    	component_subscribe($$self, colHero, $$value => $$invalidate(13, $colHero = $$value));
    	validate_store(ligHero, "ligHero");
    	component_subscribe($$self, ligHero, $$value => $$invalidate(14, $ligHero = $$value));
    	validate_store(previousLigHero, "previousLigHero");
    	component_subscribe($$self, previousLigHero, $$value => $$invalidate(15, $previousLigHero = $$value));
    	validate_store(previousColHero, "previousColHero");
    	component_subscribe($$self, previousColHero, $$value => $$invalidate(16, $previousColHero = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(17, $direction = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(18, $nbrLig = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(19, $nbrCol = $$value));
    	validate_store(step, "step");
    	component_subscribe($$self, step, $$value => $$invalidate(20, $step = $$value));
    	validate_store(retry, "retry");
    	component_subscribe($$self, retry, $$value => $$invalidate(21, $retry = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
