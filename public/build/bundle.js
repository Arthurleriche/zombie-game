...
>>>>>>> 62ab9dbe1becf7b14a1cd5ea4eb5c974156bc43a
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 56, 0, 1400);
    			attr_dev(div0, "id", "tableau");
    			add_location(div0, file$1, 58, 2, 1486);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			img = element("img");
    			attr_dev(img, "class", img_class_value = "" + (/*$direction*/ ctx[0] + /*$step*/ ctx[1] + " svelte-26p0fn"));
    			attr_dev(img, "id", "hero");
    			if (img.src !== (img_src_value = "./resources/space_hero.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$2, 88, 4, 981);
    			attr_dev(div0, "class", "hero svelte-26p0fn");
    			add_location(div0, file$2, 87, 2, 958);
    			add_location(div1, file$2, 86, 0, 950);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$direction, $step*/ 3 && img_class_value !== (img_class_value = "" + (/*$direction*/ ctx[0] + /*$step*/ ctx[1] + " svelte-26p0fn"))) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, direction, $$value => $$invalidate(0, $direction = $$value));
    	...
    	$$self.$capture_state = () => ({ step, direction, $direction, $step });
...
>>>>>>> 62ab9dbe1becf7b14a1cd5ea4eb5c974156bc43a
    ...
    function create_fragment$7(ctx) {
    	...
    	let td_class_value;
    	let current;
    	let if_block0 = /*idCase*/ ctx[0] === "p" && create_if_block_2(ctx);
    	let if_block1 = /*idCase*/ ctx[0] === "fire" && create_if_block_1(ctx);
    	let if_block2 = /*idCase*/ ctx[0] === "ship" && create_if_block(ctx);
...
<<<<<<< HEAD
    			...
    			add_location(td, file$5, 23, 0, 461);
=======
...
>>>>>>> 62ab9dbe1becf7b14a1cd5ea4eb5c974156bc43a
    	...
    	$$self.$capture_state = () => ({ onMount, Hero, Fire, Ship, Empty, idCase });
    ...
    class Case extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { idCase: 0 });
...
<<<<<<< HEAD
    			if (dirty & /*$tableau*/ 1) case_1_changes.idCase = /*col*/ ctx[17];
=======
...
<<<<<<< HEAD
    			add_location(tr, file$6, 166, 8, 4092);
=======
...
>>>>>>> 62ab9dbe1becf7b14a1cd5ea4eb5c974156bc43a
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
<<<<<<< HEAD
    		source: "(166:6) {#each $tableau as lig}",
=======
...
<<<<<<< HEAD
    			...
    			add_location(div0, file$6, 163, 2, 4016);
    			attr_dev(div1, "class", "flex flex-col justify-around w-full");
    			add_location(div1, file$6, 162, 0, 3964);
=======
    			t = space();
    			button = element("button");
...
<<<<<<< HEAD
    			if (dirty & /*$$scope, $tableau*/ 1048577) {
=======
...
<<<<<<< HEAD
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, ligHero, $$value => $$invalidate(5, $ligHero = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(6, $nbrLig = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(7, $direction = $$value));
    	validate_store(tableau, "tableau");
    	component_subscribe($$self, tableau, $$value => $$invalidate(0, $tableau = $$value));
    	validate_store(colHero, "colHero");
    	component_subscribe($$self, colHero, $$value => $$invalidate(8, $colHero = $$value));
    	validate_store(step, "step");
    	component_subscribe($$self, step, $$value => $$invalidate(9, $step = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(10, $nbrCol = $$value));
=======
    function instance$5($$self, $$props, $$invalidate) {
    	let $ligHero;
    	let $nbrLig;
...
>>>>>>> 62ab9dbe1becf7b14a1cd5ea4eb5c974156bc43a
    					...
    					if ($step === 3) {
    						...
    						set_store_value(step, $step++, $step);
    					}
    				}
    			}
    		}
