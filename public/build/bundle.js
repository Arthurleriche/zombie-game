...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$tableau*/ 4) case_1_changes.idCase = /*col*/ ctx[34];
    ...
    // (271:6) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
    	let each_value_1 = /*lig*/ ctx[31];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$8, 271, 8, 6888);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(271:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 268, 2, 6812);
    			attr_dev(div1, "class", "flex flex-col justify-around h-auto w-full");
    			add_location(div1, file$8, 267, 0, 6753);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*gameOver, $tableau, stp*/ 7 | dirty[1] & /*$$scope*/ 64) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, previousLigHero, $$value => $$invalidate(14, $previousLigHero = $$value));
    	validate_store(previousColHero, "previousColHero");
    	component_subscribe($$self, previousColHero, $$value => $$invalidate(15, $previousColHero = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(16, $direction = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(17, $nbrLig = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(18, $nbrCol = $$value));
    	validate_store(step, "step");
    	component_subscribe($$self, step, $$value => $$invalidate(19, $step = $$value));
    	validate_store(retry, "retry");
    	component_subscribe($$self, retry, $$value => $$invalidate(20, $retry = $$value));
