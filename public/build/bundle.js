...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 106, 0, 2789);
    			attr_dev(div0, "id", "tableau");
    			add_location(div0, file$2, 108, 2, 2892);
    			attr_dev(div1, "class", "tableau ");
    			add_location(div1, file$2, 107, 0, 2867);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			img = element("img");
    			attr_dev(img, "class", img_class_value = "right" + /*alienStep*/ ctx[0] + " svelte-dmmig5");
    			attr_dev(img, "id", "alien1");
    			if (img.src !== (img_src_value = "./resources/alien1.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file$6, 20, 2, 472);
    			attr_dev(div, "class", "alien1 svelte-dmmig5");
    			set_style(div, "left", /*$leftAlien*/ ctx[1] + "px");
    			set_style(div, "top", /*$topAlien*/ ctx[2] + "px");
    			add_location(div, file$6, 19, 0, 402);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*alienStep*/ 1 && img_class_value !== (img_class_value = "right" + /*alienStep*/ ctx[0] + " svelte-dmmig5")) {
    				attr_dev(img, "class", img_class_value);
    			}

    			if (dirty & /*$leftAlien*/ 2) {
    				set_style(div, "left", /*$leftAlien*/ ctx[1] + "px");
    			}
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, leftAlien, $$value => $$invalidate(1, $leftAlien = $$value));
    	validate_store(topAlien, "topAlien");
    	component_subscribe($$self, topAlien, $$value => $$invalidate(2, $topAlien = $$value));
    	...
    	return [alienStep, $leftAlien, $topAlien];
    }
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(td, file$7, 27, 0, 558);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Case extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*alienStep*/ ctx[0] === undefined && !("alienStep" in props)) {
    			console.warn("<Case> was created without expected prop 'alienStep'");
    		}
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$tableau*/ 2) case_1_changes.idCase = /*col*/ ctx[41];
    ...
    // (312:6) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
    	let each_value_1 = /*lig*/ ctx[38];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$8, 312, 8, 7877);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(312:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 309, 2, 7801);
    			attr_dev(div1, "class", "flex flex-col justify-around h-auto w-full");
    			add_location(div1, file$8, 308, 0, 7742);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*gameOver, $tableau*/ 3 | dirty[1] & /*$$scope*/ 8192) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	let $retry;
    	validate_store(ligAlien, "ligAlien");
    	component_subscribe($$self, ligAlien, $$value => $$invalidate(10, $ligAlien = $$value));
    	validate_store(colAlien, "colAlien");
    	component_subscribe($$self, colAlien, $$value => $$invalidate(11, $colAlien = $$value));
    	validate_store(bottomSide, "bottomSide");
    	component_subscribe($$self, bottomSide, $$value => $$invalidate(12, $bottomSide = $$value));
    	validate_store(leftSide, "leftSide");
    	component_subscribe($$self, leftSide, $$value => $$invalidate(13, $leftSide = $$value));
    	validate_store(previousLigAlien, "previousLigAlien");
    	component_subscribe($$self, previousLigAlien, $$value => $$invalidate(14, $previousLigAlien = $$value));
    	validate_store(previousColAlien, "previousColAlien");
    	component_subscribe($$self, previousColAlien, $$value => $$invalidate(15, $previousColAlien = $$value));
    	validate_store(leftAlien, "leftAlien");
    	component_subscribe($$self, leftAlien, $$value => $$invalidate(16, $leftAlien = $$value));
    	validate_store(topAlien, "topAlien");
    	component_subscribe($$self, topAlien, $$value => $$invalidate(17, $topAlien = $$value));
    	validate_store(tableau, "tableau");
    	component_subscribe($$self, tableau, $$value => $$invalidate(1, $tableau = $$value));
    	validate_store(previousLigHero, "previousLigHero");
    	component_subscribe($$self, previousLigHero, $$value => $$invalidate(18, $previousLigHero = $$value));
    	validate_store(ligHero, "ligHero");
    	component_subscribe($$self, ligHero, $$value => $$invalidate(19, $ligHero = $$value));
    	validate_store(previousColHero, "previousColHero");
    	component_subscribe($$self, previousColHero, $$value => $$invalidate(20, $previousColHero = $$value));
    	validate_store(colHero, "colHero");
    	component_subscribe($$self, colHero, $$value => $$invalidate(21, $colHero = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(22, $direction = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(23, $nbrLig = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(24, $nbrCol = $$value));
    	validate_store(retry, "retry");
    	component_subscribe($$self, retry, $$value => $$invalidate(25, $retry = $$value));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$7.warn(`<Level> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("stp" in $$props) $$invalidate(2, stp = $$props.stp);
    	...
    	return [gameOver, $tableau, stp, handleRetry];
    }
