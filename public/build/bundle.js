...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 110, 0, 3000);
    			attr_dev(div0, "id", "tableau");
    			add_location(div0, file$2, 112, 2, 3103);
    			attr_dev(div1, "class", "tableau ");
    			add_location(div1, file$2, 111, 0, 3078);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$tableau*/ 2) case_1_changes.idCase = /*col*/ ctx[40];
    ...
    // (295:6) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
    	let each_value_1 = /*lig*/ ctx[37];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$8, 295, 8, 7435);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(295:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 292, 2, 7359);
    			attr_dev(div1, "class", "flex flex-col justify-around h-auto w-full");
    			add_location(div1, file$8, 291, 0, 7300);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*gameOver, $tableau*/ 3 | dirty[1] & /*$$scope*/ 4096) {
