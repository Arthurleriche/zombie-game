    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td, "class", td_class_value = "border cel " + /*idCase*/ ctx[0] + " border-none" + " svelte-1bjb94o");
    			add_location(td, file$3, 18, 0, 278);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*idCase*/ 1 && td_class_value !== (td_class_value = "border cel " + /*idCase*/ ctx[0] + " border-none" + " svelte-1bjb94o")) {
