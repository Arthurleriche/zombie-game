...
<<<<<<< HEAD
    			add_location(p, file$1, 59, 0, 1464);
    			attr_dev(div0, "id", "tableau");
    			add_location(div0, file$1, 61, 2, 1550);
    			attr_dev(div1, "class", "tableau");
    			add_location(div1, file$1, 60, 0, 1526);
=======
    			add_location(p, file$1, 60, 0, 1545);
    			attr_dev(div0, "id", "tableau");
    			add_location(div0, file$1, 62, 2, 1631);
    			attr_dev(div1, "class", "tableau");
    			add_location(div1, file$1, 61, 0, 1607);
...
<<<<<<< HEAD
    			if (dirty & /*$tableau*/ 1) case_1_changes.idCase = /*col*/ ctx[19];
=======
    			if (dirty & /*$tableau*/ 4) case_1_changes.idCase = /*col*/ ctx[23];
...
=======
    // (219:6) {#each $tableau as lig}
>>>>>>> 39b28bb24b53f0c0b7d9e35626d8126734209bac
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
<<<<<<< HEAD
    	let each_value_1 = /*lig*/ ctx[16];
=======
    	let each_value_1 = /*lig*/ ctx[20];
>>>>>>> 39b28bb24b53f0c0b7d9e35626d8126734209bac
...
<<<<<<< HEAD
    			add_location(tr, file$6, 168, 8, 4403);
=======
    			add_location(tr, file$7, 219, 8, 5607);
>>>>>>> 39b28bb24b53f0c0b7d9e35626d8126734209bac
    		},
    		m: function mount(target, anchor) {
...
<<<<<<< HEAD
    			if (dirty & /*$tableau*/ 1) {
    				each_value_1 = /*lig*/ ctx[16];
=======
    			if (dirty & /*$tableau, stp*/ 6) {
    				each_value_1 = /*lig*/ ctx[20];
>>>>>>> 39b28bb24b53f0c0b7d9e35626d8126734209bac
    				validate_each_argument(each_value_1);
    				let i;
...
=======
    		source: "(219:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", " gameover svelte-1qkv0va");
    			add_location(div, file$7, 226, 8, 5780);
    			attr_dev(button, "class", "m-auto rounded-lg bg-black text-white retry h-16 w-40 svelte-1qkv0va");
    			add_location(button, file$7, 227, 8, 5826);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			insert_dev(target, t1, anchor);
...
<<<<<<< HEAD
    			add_location(div0, file$6, 165, 2, 4327);
    			attr_dev(div1, "class", "flex flex-col justify-around w-full");
    			add_location(div1, file$6, 164, 0, 4275);
=======
    			add_location(div0, file$7, 216, 2, 5531);
    			attr_dev(div1, "class", "flex flex-col justify-around w-full");
    			add_location(div1, file$7, 215, 0, 5479);
>>>>>>> 39b28bb24b53f0c0b7d9e35626d8126734209bac
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
...
<<<<<<< HEAD
    			if (dirty & /*$$scope, $tableau*/ 4194305) {
=======
    			if (dirty & /*$$scope, gameOver, $tableau, stp*/ 67108871) {
>>>>>>> 39b28bb24b53f0c0b7d9e35626d8126734209bac
...
<<<<<<< HEAD
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	let $step;
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(5, $direction = $$value));
    	validate_store(ligHero, "ligHero");
    	component_subscribe($$self, ligHero, $$value => $$invalidate(6, $ligHero = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(7, $nbrLig = $$value));
    	validate_store(bottomSide, "bottomSide");
    	component_subscribe($$self, bottomSide, $$value => $$invalidate(8, $bottomSide = $$value));
    	validate_store(tableau, "tableau");
    	...
    	validate_store(leftSide, "leftSide");
    	component_subscribe($$self, leftSide, $$value => $$invalidate(10, $leftSide = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(11, $nbrCol = $$value));
    	validate_store(step, "step");
    	component_subscribe($$self, step, $$value => $$invalidate(12, $step = $$value));
    	let down = false;
    	let up = false;
    	let right = false;
    	let left = false;
=======
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(11, $nbrLig = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(12, $direction = $$value));
    	validate_store(step, "step");
    	component_subscribe($$self, step, $$value => $$invalidate(13, $step = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(14, $nbrCol = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
