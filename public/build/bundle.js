...
var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$tableau*/ 2) case_1_changes.idCase = /*col*/ ctx[39];
    ...
    // (298:6) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
    	let each_value_1 = /*lig*/ ctx[36];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$8, 298, 8, 7717);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(298:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 295, 2, 7641);
    			attr_dev(div1, "class", "flex flex-col justify-around h-auto w-full");
    			add_location(div1, file$8, 294, 0, 7582);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*gameOver, $tableau*/ 3 | dirty[1] & /*$$scope*/ 2048) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	validate_store(leftAlien, "leftAlien");
    	component_subscribe($$self, leftAlien, $$value => $$invalidate(14, $leftAlien = $$value));
    	validate_store(tableau, "tableau");
    	component_subscribe($$self, tableau, $$value => $$invalidate(1, $tableau = $$value));
    	validate_store(topAlien, "topAlien");
    	component_subscribe($$self, topAlien, $$value => $$invalidate(15, $topAlien = $$value));
    	validate_store(previousLigHero, "previousLigHero");
    	component_subscribe($$self, previousLigHero, $$value => $$invalidate(16, $previousLigHero = $$value));
    	validate_store(ligHero, "ligHero");
    	component_subscribe($$self, ligHero, $$value => $$invalidate(17, $ligHero = $$value));
    	validate_store(previousColHero, "previousColHero");
    	component_subscribe($$self, previousColHero, $$value => $$invalidate(18, $previousColHero = $$value));
    	validate_store(colHero, "colHero");
    	component_subscribe($$self, colHero, $$value => $$invalidate(19, $colHero = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(20, $direction = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(21, $nbrLig = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(22, $nbrCol = $$value));
    	validate_store(step, "step");
    	component_subscribe($$self, step, $$value => $$invalidate(23, $step = $$value));
    	validate_store(retry, "retry");
    	component_subscribe($$self, retry, $$value => $$invalidate(24, $retry = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
