...
var app = (function () {
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		if ("alienStep" in $$props) $$invalidate(3, alienStep = $$props.alienStep);
    	};
    	...
    	return [$leftAlien, $topAlien, $directionAlien, alienStep];
    }

    class Enemies extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { alienStep: 3 });
    		...
    		if (/*alienStep*/ ctx[3] === undefined && !("alienStep" in props)) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$tableau*/ 2) case_1_changes.idCase = /*col*/ ctx[42];
    ...
    // (317:6) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let current;
    	let each_value_1 = /*lig*/ ctx[39];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$8, 317, 8, 8098);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(317:6) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$8, 314, 2, 8022);
    			attr_dev(div1, "class", "flex flex-col justify-around h-auto w-full");
    			add_location(div1, file$8, 313, 0, 7963);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*gameOver, $tableau*/ 3 | dirty[1] & /*$$scope*/ 16384) {
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	validate_store(directionAlien, "directionAlien");
    	component_subscribe($$self, directionAlien, $$value => $$invalidate(17, $directionAlien = $$value));
    	validate_store(topAlien, "topAlien");
    	component_subscribe($$self, topAlien, $$value => $$invalidate(18, $topAlien = $$value));
    	validate_store(tableau, "tableau");
    	component_subscribe($$self, tableau, $$value => $$invalidate(1, $tableau = $$value));
    	validate_store(previousLigHero, "previousLigHero");
    	component_subscribe($$self, previousLigHero, $$value => $$invalidate(19, $previousLigHero = $$value));
    	validate_store(ligHero, "ligHero");
    	component_subscribe($$self, ligHero, $$value => $$invalidate(20, $ligHero = $$value));
    	validate_store(previousColHero, "previousColHero");
    	component_subscribe($$self, previousColHero, $$value => $$invalidate(21, $previousColHero = $$value));
    	validate_store(colHero, "colHero");
    	component_subscribe($$self, colHero, $$value => $$invalidate(22, $colHero = $$value));
    	validate_store(direction, "direction");
    	component_subscribe($$self, direction, $$value => $$invalidate(23, $direction = $$value));
    	validate_store(nbrLig, "nbrLig");
    	component_subscribe($$self, nbrLig, $$value => $$invalidate(24, $nbrLig = $$value));
    	validate_store(nbrCol, "nbrCol");
    	component_subscribe($$self, nbrCol, $$value => $$invalidate(25, $nbrCol = $$value));
    	validate_store(retry, "retry");
    	component_subscribe($$self, retry, $$value => $$invalidate(26, $retry = $$value));
    	...
    	const update = () => {
    		...
    		if (collision === true) {
    			collision = false;
    			set_store_value(directionAlien, $directionAlien = "down");
    		} else {
    			iti.advance();
    		}
