...
var app = (function () {
    ...
    /* src/components/Hero1.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 23, 0, 551);
    			add_location(div, file$3, 24, 0, 594);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/Hero2.svelte generated by Svelte v3.24.1 */
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 108, 2, 1174);
    			attr_dev(div, "class", "hero svelte-p06ago");
    			add_location(div, file$4, 107, 0, 1153);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<Hero2> was created with unknown prop '${key}'`);
    	});
    ...
    class Hero2 extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { feature: 0, steps: 1 });
    		...
    		if (/*feature*/ ctx[0] === undefined && !("feature" in props)) {
    			console_1$2.warn("<Hero2> was created without expected prop 'feature'");
    		}

    		if (/*steps*/ ctx[1] === undefined && !("steps" in props)) {
    			console_1$2.warn("<Hero2> was created without expected prop 'steps'");
    		}
    	}

    	get feature() {
    		throw new Error("<Hero2>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set feature(value) {
    		throw new Error("<Hero2>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const hero2_changes = {};
    			if (dirty & /*feature*/ 2) hero2_changes.feature = /*feature*/ ctx[1];
    			if (dirty & /*steps*/ 4) hero2_changes.steps = /*steps*/ ctx[2];
    			hero2.$set(hero2_changes);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(td, "class", td_class_value = "border cel " + /*idCase*/ ctx[0] + " border-none" + " svelte-2x7ql8");
    			add_location(td, file$5, 18, 0, 280);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*idCase*/ 1 && td_class_value !== (td_class_value = "border cel " + /*idCase*/ ctx[0] + " border-none" + " svelte-2x7ql8")) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<Case> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ onMount, Hero2, idCase, feature, steps });
    ...
    class Case extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { idCase: 0, feature: 1, steps: 2 });
    		...
    		if (/*idCase*/ ctx[0] === undefined && !("idCase" in props)) {
    			console_1$3.warn("<Case> was created without expected prop 'idCase'");
    		}

    		if (/*feature*/ ctx[1] === undefined && !("feature" in props)) {
    			console_1$3.warn("<Case> was created without expected prop 'feature'");
    		}

    		if (/*steps*/ ctx[2] === undefined && !("steps" in props)) {
    			console_1$3.warn("<Case> was created without expected prop 'steps'");
    		}
    	}
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$tableau*/ 4) case_1_changes.idCase = /*col*/ ctx[15];
    ...
    // (162:2) {#each $tableau as lig}
    function create_each_block$1(ctx) {
    	let tr;
    	let t;
    	let current;
    	let each_value_1 = /*lig*/ ctx[12];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$6, 162, 4, 3703);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(162:2) {#each $tableau as lig}",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, $tableau, direction, foot*/ 262151) {
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$4.warn(`<Level> was created with unknown prop '${key}'`);
    	});
